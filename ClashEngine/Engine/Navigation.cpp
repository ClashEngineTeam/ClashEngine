...
namespace ClashEngine
{
    ...
    SearchResult Navigation::Navigate(Vector2 startPos, Vector2 endPos, SearchDirection searchDir, int depthLimit, SearchFunc func, SearchMethod searchMethod)
    {
        SearchResult searchResult;

        if (startPos == endPos) return searchResult;
        if (!func(endPos)) return searchResult;
