...
namespace ClashEngine
{
    ...
    //来源:https://stackoverflow.com/questions/34065/how-to-read-a-value-from-the-windows-registry
    ...
    //模仿WinReg.hpp中的SetDwordValue函数写的
    ...
    public:
        ...
        //注意:设置后需要重启控制台生效
        //调用该API后调用IsLegacyConsole无法正确返回结果, 必须要先重启控制台
